...
category_size = CategorySize.create({category_id: lady_7.id,size_id:clothes.id})
category_size = CategorySize.create({category_id: lady_18.id,size_id:clothes.id})


category_size = CategorySize.create({category_id: lady_6.id,size_id:women_shoes.id})

category_size = CategorySize.create({category_id: men_4.id,size_id:men_shoes.id})

category_size = CategorySize.create({category_id: men_1.id,size_id:clothes.id})
...
category_size = CategorySize.create({category_id: baby_kids_3.id,size_id:baby_clothes.id})
