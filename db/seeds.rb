...
# 服のサイズ
clothes = Size.create(name: "服のサイズ")
...
clothes_10 = clothes.children.create(name: "FREE SIZE")


women_shoes = Size.create(name: "靴のサイズ（女性）")
women_shoes_1 = women_shoes.children.create(name: "20cm以下")
women_shoes_2 = women_shoes.children.create(name: "20.5cm")
women_shoes_3 = women_shoes.children.create(name: "21cm")
women_shoes_4 = women_shoes.children.create(name: "21.5cm")
women_shoes_5 = women_shoes.children.create(name: "22cm")
women_shoes_6 = women_shoes.children.create(name: "22.5cm")
women_shoes_7 = women_shoes.children.create(name: "23cm")
women_shoes_8 = women_shoes.children.create(name: "23.5cm")
women_shoes_9 = women_shoes.children.create(name: "24cm")
women_shoes_10 = women_shoes.children.create(name: "24.5cm")
women_shoes_11 = women_shoes.children.create(name: "25cm")
women_shoes_12 = women_shoes.children.create(name: "25.5cm")
women_shoes_13 = women_shoes.children.create(name: "26cm")
women_shoes_14 = women_shoes.children.create(name: "26.5cm")
women_shoes_15 = women_shoes.children.create(name: "27cm")
women_shoes_16 = women_shoes.children.create(name: "27.5cm以上")

men_shoes = Size.create(name: "靴のサイズ（男性）")
men_shoes_1 = men_shoes.children.create(name: "23.5cm以下")
men_shoes_2 = men_shoes.children.create(name: "24cm")
men_shoes_3 = men_shoes.children.create(name: "24.5cm")
men_shoes_4 = men_shoes.children.create(name: "25cm")
men_shoes_5 = men_shoes.children.create(name: "25.5cm")
men_shoes_6 = men_shoes.children.create(name: "26cm")
men_shoes_7 = men_shoes.children.create(name: "26.5cm")
men_shoes_8 = men_shoes.children.create(name: "27cm")
men_shoes_9 = men_shoes.children.create(name: "27.5cm")
men_shoes_10 = men_shoes.children.create(name: "28cm")
men_shoes_11 = men_shoes.children.create(name: "28.5cm")
men_shoes_12 = men_shoes.children.create(name: "29cm")
men_shoes_13 = men_shoes.children.create(name: "29.5cm")
men_shoes_14 = men_shoes.children.create(name: "30cm")
men_shoes_15 = men_shoes.children.create(name: "30.5cm")
men_shoes_16 = men_shoes.children.create(name: "31cm以上")

baby_clothes = Size.create(name: "ベビー")
baby_clothes_1 = baby_clothes.children.create(name: "60cm")
baby_clothes_2 = baby_clothes.children.create(name: "70cm")
baby_clothes_3 = baby_clothes.children.create(name: "80cm")
baby_clothes_4 = baby_clothes.children.create(name: "90cm")
baby_clothes_5 = baby_clothes.children.create(name: "95cm")

kids_clothes = Size.create(name: "キッズ")
...
tire_wheels_3 = tire_wheels.children.create(name: "14インチ")
tire_wheels_4 = tire_wheels.children.create(name: "15インチ")
tire_wheels_5 = tire_wheels.children.create(name: "16インチ")
tire_wheels_6 = tire_wheels.children.create(name: "17インチ")
tire_wheels_7 = tire_wheels.children.create(name: "18インチ")
tire_wheels_8 = tire_wheels.children.create(name: "19インチ")
tire_wheels_9 = tire_wheels.children.create(name: "20インチ")
tire_wheels_10 = tire_wheels.children.create(name: "21インチ")
tire_wheels_11 = tire_wheels.children.create(name: "22インチ")
tire_wheels_12 = tire_wheels.children.create(name: "23インチ")
...
category_size = CategorySize.create({category_id: lady_4.id,size_id:clothes.id})
category_size = CategorySize.create({category_id: lady_5.id,size_id:clothes.id})
# category_size = CategorySize.create({category_id: lady_18.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: lady_6.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: lady_7.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: lady_8.children.ids,size_id:clothes.id})

# category_size = CategorySize.create({category_id: lady_6.children.ids,size_id:women_shoes.id})

# category_size = CategorySize.create({category_id: men_4.children.ids,size_id:men_shoes.id})

# category_size = CategorySize.create({category_id: men_1.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: men_2.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: men_3.children.ids,size_id:clothes.id})
# category_size = CategorySize.create({category_id: men_4.children.ids,size_id:clothes.id})

# category_size = CategorySize.create({category_id: baby_kids_1.children.ids,size_id:baby_clothes.id})
# category_size = CategorySize.create({category_id: baby_kids_2.children.ids,size_id:baby_clothes.id})
# category_size = CategorySize.create({category_id: baby_kids_3.children.ids,size_id:baby_clothes.id})

# category_size = CategorySize.create({category_id: baby_kids_4.children.ids,size_id:kids_clothes.id})
# category_size = CategorySize.create({category_id: baby_kids_5.children.ids,size_id:kids_clothes.id})
# category_size = CategorySize.create({category_id: baby_kids_6.children.ids,size_id:kids_clothes.id})